...
import type { getStatusAPIResponse } from "../types/getterSchema";
...
// Hook envoyant un audio en post et récupère la transcription en polling
export const useTranscription = (audio: Audio | null) : UseTranscriptionReturn => {
  ...
  useEffect(() => {
    ...
    setStatusInfo("Initialisation de l'envoi...");
